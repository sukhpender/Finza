...
import com.riggle.plug.databinding.FragmentGraphBinding
...
class GraphFragment : BaseFragment<FragmentGraphBinding>() {
    ...
    private val viewModel: GraphFragmentVM by viewModels()
            ...
            when (it?.status) {
                ...
                Status.SUCCESS -> {
                    ...
                    if (it.data != null) {
                        ...
                        binding.nsvBeatGraph.visibility = View.GONE
                    }
                }
