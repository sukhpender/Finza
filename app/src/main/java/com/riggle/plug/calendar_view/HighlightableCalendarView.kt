...
import com.riggle.plug.calendar_view.util.getFullNameOfMonth
import com.riggle.plug.calendar_view.util.isSameDay
import com.riggle.plug.calendar_view.util.isSameMonth
import com.riggle.plug.calendar_view.util.isThisCalendarOfNextMonthFrom
import com.riggle.plug.calendar_view.util.isThisCalendarOfPreviousMonthFrom
import com.riggle.plug.calendar_view.util.removeTime
import com.riggle.plug.databinding.ViewHighlightableCalendarBinding
    ...
    private fun readAndInitializeAttributes(attr: AttributeSet?, defStyleAttr: Int) {
        attr?.let {
            ...
            this.firstDayOfWeek = DayOfWeek.values()[attributeValues.getInt(
                R.styleable.HighlightableCalendarView_firstWeekDay,
