...
public class CustomXAxisRendererMonthly extends XAxisRenderer {
    public CustomXAxisRendererMonthly(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans) {
