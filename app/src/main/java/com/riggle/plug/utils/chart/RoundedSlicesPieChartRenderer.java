        ...
        for (int j = 0; j < entryCount; j++) {
            ...
            if (sweepAngleOuter >= 360.f && sweepAngleOuter % 360f <= Utils.FLOAT_EPSILON) {
                ...
                if (drawInnerArc) {
                    ...
                    pathBuffer.arcTo(roundedCircleBox, startAngleOuter - 180, 90);
                }
            ...
            if (drawInnerArc && (innerRadius > 0.f || accountForSliceSpacing)) {
                ...
                if (sweepAngleOuter >= 360.f && sweepAngleOuter % 360f <= Utils.FLOAT_EPSILON) {
                    ...
                    pathBuffer.arcTo(roundedCircleBox, endAngleInner, 90);
                ...
                if (sweepAngleOuter % 360f > Utils.FLOAT_EPSILON) {
                    if (accountForSliceSpacing) {
                        ...
                        float arcEndPointX = center.x +
                                sliceSpaceOffset * (float) Math.cos(angleMiddle * Utils.DEG2RAD);
                        float arcEndPointY = center.y +
                                sliceSpaceOffset * (float) Math.sin(angleMiddle * Utils.DEG2RAD);
