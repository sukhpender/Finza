...
class BaseRepoImpl @Inject constructor(private val apiService: BaseApi) : BaseRepo {
    ...
    override suspend fun activations(header: String,month: String): Response<ActivationsResponseModel> {
        return apiService.activations(header,month)
    }

    override suspend fun tagReplacement(
        header: String,
